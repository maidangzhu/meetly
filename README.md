...
- 不按 Enter 时，场边教练也可以基于转写上下文给短提示。
- 展开面板里建议和场边教练内容要始终可见，转写可以滚动。
...
- [场边教练叫醒策略](./docs/AGENT_WAKE_STRATEGY.md)
- [专注体验审查](./docs/UX_FOCUS_REVIEW.md)
- [Rust Agent Wake Runtime Design](./docs/RUST_AGENT_WAKE_RUNTIME_DESIGN.md)

OpenSpec 变更记录在 `openspec/changes/`：

- `stabilize-interview-assist-p0`
- `add-interview-auto-assist-p1`
- `add-coach-wake-policy`
